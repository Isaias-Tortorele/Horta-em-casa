        ...
        <LinearGradient colors={['#FFF', '#000' ]} style={styles.container}>
            ...
            <View style={styles.containerContent}>
                <View>
                    ...
                    <View>
                        <Text style={styles.subtitle}>Clima e solo</Text>
                    ...
                    { route.params?.data.enxerto ? (
                    <View>
                        <Text style={styles.subtitle}>Enxerto</Text>
                        <Text style={styles.textAbout}>{route.params?.data.enxerto}</Text>
                    </View>   
                    ) : (
                    <View/>
                    )
